...
def quiz_gam():
    ...
    def easy_level():                       
        ...
        def answer(event=None):             
            ...
            if ans=='365':                  #if user enters correct answer  
                label=Label(easy_level,text='Absolutly correct',bg='light green')
                ...
                label=Label(easy_level,text='Unfortunatly your answer is wrong and the correct answer is 365',bg='red')
                label.place(relx=0.5,rely=0.25,anchor='center')
                answer_1.configure(state=tk.DISABLED)   #once the player has entered his answer answer_1 will get disabled
        ...
        def answer_a(event=None):
            ...
            if ans=='12':
                ...
                label=Label(easy_level,text='Unfortunatly your answer is wrong and the correct answer is 12',bg='red')
                label.place(relx=0.5,rely=0.55,anchor='center')
                answer_2.configure(state=tk.DISABLED)
        ...
        def answer_b(event=None):
            ...
            if ans=='35':
                ...
                label=Label(easy_level,text='Unfortunatly your answer is wrong and the correct answer is 35',bg='red')
                label.place(relx=0.5,rely=0.85,anchor='center')
                answer_3.configure(state=tk.DISABLED)
                num=total.get()
                with open('score.txt','w') as file:             #open score file to save final score
    ...
    def medium_level():
        ...
        def answer(event=None):
            ...
            if ans=='mercury':
                label=Label(medium_level,text='Absolutly correct',bg='light green')
                label.place(relx=0.5,rely=0.25,anchor='center')
                answer_1.configure(state=tk.DISABLED)
                counter()
            else:
                label=Label(medium_level,text='Unfortunatly your answer is wrong and the correct answer is mercury',bg='red')
                label.place(relx=0.5,rely=0.25,anchor='center')
                answer_1.configure(state=tk.DISABLED)
        def answer_a(event=None):
            ...
            if ans=='thomus edison':
                ...
                label=Label(medium_level,text='Unfortunatly your answer is wrong and the correct answer is thomus edison',bg='red')
                label.place(relx=0.5,rely=0.55,anchor='center')
                answer_2.configure(state=tk.DISABLED)
        ...
        def answer_b(event=None):
            ...
            if ans=='12':
                ...
                label=Label(medium_level,text='Unfortunatly your answer is wrong and the correct answer is 12',bg='red')
                label.place(relx=0.5,rely=0.85,anchor='center')
                answer_3.configure(state=tk.DISABLED)
                num=total.get()
                with open('score.txt','w') as file:
    ...
    def HARD_level():
        ...
        def answer(event=None):
            ans=str.lower(answer_1.get())   
            if ans=='mars':
                label=Label(HARD_level,text='Absolutly correct',bg='light green')
                label.place(relx=0.5,rely=0.25,anchor='center')
                answer_1.configure(state=tk.DISABLED)
                counter()
            else:
                label=Label(HARD_level,text='Unfortunatly your answer is wrong and the correct answer is mars',bg='red')
                label.place(relx=0.5,rely=0.25,anchor='center')
                answer_1.configure(state=tk.DISABLED)
        def answer_a(event=None):
            ans=str.lower(answer_2.get())    
            if ans=='water':
                ...
                label=Label(HARD_level,text='Unfortunatly your answer is wrong and the correct answer is WATER,',bg='red')
                label.place(relx=0.5,rely=0.55,anchor='center')
                answer_2.configure(state=tk.DISABLED)
        ...
        def answer_b(event=None):
            ...
            if ans=='mount everest':
                ...
                label=Label(HARD_level,text='Unfortunatly your answer is wrong and the correct answer is mount everest',bg='red')
                label.place(relx=0.5,rely=0.85,anchor='center')
                answer_3.configure(state=tk.DISABLED)
                num=total.get()
                with open('score.txt','w') as file:
